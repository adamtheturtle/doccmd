...
.. code-block:: console
   ...
   $ curl --fail -L https://github.com/adamtheturtle/doccmd/releases/download/2026.05.06/doccmd-linux -o /usr/local/bin/doccmd &&
...
.. code-block:: console
   ...
   $ curl --fail -L https://github.com/adamtheturtle/doccmd/releases/download/2026.05.06/doccmd-macos -o /usr/local/bin/doccmd &&
       chmod +x /usr/local/bin/doccmd
...
.. code-block:: shell
   ...
   $ nix --extra-experimental-features 'nix-command flakes' run "github:adamtheturtle/doccmd/2026.05.06" -- --help
